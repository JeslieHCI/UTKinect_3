...
function [total_accuracy, class_wise_accuracy, confusion_matrix,...
    ...
    train_prediction_prob = zeros(n_classes, n_train_samples);
    ...
    for i = 1:n_classes          
        ...
        prob_ = K_train_train{i}(:, full(svm_model.SVs))*svm_model.sv_coef...
            - svm_model.rho*ones(n_train_samples,1);
