function [] = perform_classification(root_dir, subject_labels, action_labels,...
    ...
    train_prediction_prob = cell(n_tr_te_splits, 1);
    test_prediction_prob = cell(n_tr_te_splits, 1);
    train_labels = cell(n_tr_te_splits, 1);
    test_labels = cell(n_tr_te_splits, 1);
    ...
    for i = 1:n_tr_te_splits         
        ...
        train_labels{i} = tr_labels;
        test_labels{i} = te_labels;
        ...
        [total_accuracy(i), cw_accuracy(i,:), confusion_matrices{i},...
            train_prediction_prob{i}, test_prediction_prob{i}] =...
    ...
    'test_prediction_prob', 'train_prediction_prob', 'train_labels', 'test_labels');
    
%     save ([results_dir, '/classification_results.mat'],...
%         'total_accuracy', 'cw_accuracy', 'avg_total_accuracy',...
%         'avg_cw_accuracy', 'confusion_matrices', 'avg_confusion_matrix', ...
%         'test_prediction_prob', 'train_prediction_prob');
